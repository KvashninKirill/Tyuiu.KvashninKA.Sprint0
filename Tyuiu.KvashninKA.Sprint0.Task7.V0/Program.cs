...
using Tyuiu.KvashninKA.Sprint0.Task7.V0.Lib;
namespace Tyuiu.KvashninKA.Sprint0.Task7.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнил: Квашнин К. А. | ПКТб-26-1";
            Console.WriteLine("***************************************************************************");
            ...
            {
                int[] resultArray = DataService.AdditionArrays(arrayNums1, arrayNums1);
